...
interface ICardBed {
    ...
    resetBed: boolean;
    setCurentRoom: React.Dispatch<React.SetStateAction<any>>;
    item?: RoomModel,
    setDataBed: React.Dispatch<React.SetStateAction<any>>
    dataBed: BedModel[],
    recallBed: boolean
}
...
const CardBed = (props: ICardBed) => {
    ...
    const getAllBed = async () => {
        try {
            ...
            const { data } = await axios.post('https://localhost:7120/api/Bed/AllBed', model)
